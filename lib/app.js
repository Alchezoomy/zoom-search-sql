...
const v1FilterMeetingData = require("./utils/v1FilterMeetingData.js"); // const { filter } = require("minimatch");
const filterMeetingData = require("./utils/filterMeetingData.js"); // const { filter } = require("minimatch");
...
app.post("/new_meeting", async (req, res) => {
  try {
    ...
    await v1FilterMeetingData(new_meeting);
    res.status(200);
  } catch (e) {
...
app.get("/seed_meetings", async (req, res) => {
  try {
    ...
    await v1FilterMeetingData(returnedObject.body);
