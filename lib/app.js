...
// hmmm, curious why this token never seems to be used? is it because you use OAuth to get a fresh token based on the user? If so, this extra const is confusing.
...
app.get('/api/transcripts/', async (req, res) => {
  try {
    // seems like this const should be deleted
...
app.get('/api/bookmarks', async (req, res) => {
  try {
    // looks good--I wonder why not just * this SELECT, since you're only pulling from one table?
    const data = await client.query(
      `
    SELECT
    bookmarks.id,
